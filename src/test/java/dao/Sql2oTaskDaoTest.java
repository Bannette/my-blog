...
public class Sql2oTaskDaoTest {
    ...
    public static void setUp() throws Exception {
        String connectionString = "jdbc:postgresql://localhost:5432/myblog_test"; // connect to postgres test database
        Sql2o sql2o = new Sql2o(connectionString, "user", "666Nikol-");         // changed user and pass to null
    ...
    public void addingTaskSetsId() throws Exception {
        ...
        assertEquals(originalTaskId, task.getId()); //how does this work?
    }
